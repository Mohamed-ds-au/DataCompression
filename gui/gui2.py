...
#         sidebar.place(x= 0)
#         showsidebar_button.config(bg_color= sidebar.cget("bg_color"))
#         print(sidebar.cget("bg_color"))
#     else:
#         sidebar.place_forget()
#         showsidebar_button.config(bg_color= mainWindow.cget("bg_color"))
#         print(mainWindow.cget("bg_color"))
...
def createButton(frame, text):
    button = tk.CTkButton(frame,
                       border_width= 0,
                       activebackground= frame.cget("bg_color"),
                       activeforeground= sidebarButtonsActivateColorFG,
                       background= frame.cget("bg_color"),
                       compound= "center",
                       text= text,
                       font= ("Arial",)
                       )
...
#--------- assets ---------------#
# menuiamge = Image.open('menu.png')
# sideBarMenu = tk.CTkImage(menuiamge)
# menuiamge = Image.open()
# firstAlgorithmPhoto = tk.CTkImage('Rectangle1.png')
# activeFirstAlgorithmPhoto = tk.CTkImage( 'Rectangle2.png')
# orange_button = tk.CTkImage( "button_orange.png")
# homeBackGround = Image.open("cato.png")
# homeBackGround = tk.CTkImage(homeBackGround)
# chooseButtonPhoto = tk.CTkImage( "chooseButto.png")
# compressPhoto = tk.CTkImage( "compress.png")
...
sidebar = tk.CTkFrame(
    mainWindow,
    bg_color=sideBarColor,
    height=1260,
    width=240,)
sidebar.place(x= 0)
sidebar.pack_propagate(False)

homebutton = createButton(frame= sidebar, text= "Home")
homebutton.place(x= 5,y=146)
homebutton.config(command= openHomeFrame)
algobutton = createButton(frame= sidebar, text= "Algorithms")
algobutton.place(x= 5,y=216)
algobutton.config(command= openAlgorithmFrame)

aboutbutton = createButton(frame= sidebar, text= "About")
...
#                         highlightthickness=0,
#                         borderwidth=0,
#                         bg_color=mainWindow.cget("bg_color"),
...
nLabel = tk.Label(master= golombTab, text= "The N number:", bg_color= aboutFrameColor, fg= "white", font= ("Arial", 15) )
...
#--------------- about frame ---------------#
noteImage = tk.CTkImage( "notes.png")
huffman = tk.CTkImage( "huffman.png")
aboutFrame = tk.Frame(
...
frame = tk.Frame(aboutCanva, bg_color="white", width=framesWidth, height=framesHeight) 
